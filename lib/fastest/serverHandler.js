...
exports.handleRequest = function () {
    var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(ctx, next) {
        var fastest, proxyRequestOpts, svrRes, content, callRewrite, rewriteResult;
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        // 创建 fastest
                        fastest = new Fastest(ctx.options.proxyEnv, {
                            fullUrl: ctx.fullUrl,
                    ...
                    case 14:
                        ...
                        // html 和静态文件处理不一样
                        callRewrite = fastest.isHTML() ? fastest.getRewriteHtml : fastest.getRewriteStatic;

                        // 获取改写后的结果

                        _context.next = 18;
                        return callRewrite.call(fastest, content, ctx);

                    case 18:
                        rewriteResult = _context.sent;
